...
public class Camera {
    ...
    private final int LOGICAL_WIDTH = (int) (PreInitialisedParameters.SIM_WIDTH / scale);
    private final int LOGICAL_HEIGHT = (int) (PreInitialisedParameters.SIM_HEIGHT / scale);
